...
BEGIN
    ...
    IF p_letra_assento NOT IN(SELECT cd_letra_assento FROM assento WHERE cd_sala = v_cd_sala) OR p_n_assento NOT IN(SELECT cd_numero_assento FROM assento WHERE cd_sala = v_cd_sala) THEN
	SELECT 'Nao';
